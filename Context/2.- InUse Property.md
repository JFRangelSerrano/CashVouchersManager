...
Este documento debe interpretarse como una **extensión del prompt principal**, aplicándose después de haber procesado el archivo base del proyecto.
...
- No se puede establecer `InUse = true` si el vale:
  - Está redimido
  - Está expirado
